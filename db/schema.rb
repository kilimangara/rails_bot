...
ActiveRecord::Schema.define(version: 20171211011224) do
  ...
  create_table "bundle_lines", force: :cascade do |t|
    ...
    t.index ["variant_id"], name: "index_bundle_lines_on_variant_id"
  end
  ...
  create_table "notification_locations", force: :cascade do |t|
    t.float "longitude"
    t.float "latitude"
